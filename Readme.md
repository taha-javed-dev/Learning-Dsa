...
- To keep all my implementations organized
- To improve problem-solving with consistent coding
- To see how my code quality gets better over time
...
## Current Status (What I'm Learning Now)
- Recursion
...
- Understand patterns (recursion, sliding window, etc.)
- Practice 300–500 quality DSA problems
- Be interview-ready in the long run
